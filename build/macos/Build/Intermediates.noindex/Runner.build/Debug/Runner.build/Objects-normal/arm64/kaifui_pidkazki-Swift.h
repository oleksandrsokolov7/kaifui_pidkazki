...
#ifndef KAIFUI_PIDKAZKI_SWIFT_H
#define KAIFUI_PIDKAZKI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kaifui_pidkazki",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15kaifui_pidkazki11AppDelegate")
...
SWIFT_CLASS("_TtC15kaifui_pidkazki17MainFlutterWindow")
